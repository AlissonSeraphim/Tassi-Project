  ...
  render() {
    return (
      <div className="text-gray-600 dark:text-gray-300" id="testimonials">
        <section className="relative z-10 overflow-hidden bg-white py-20 lg:py-[120px]" id="testimonials">
          <div className="container mx-auto">
            <div className="-mx-4 flex flex-wrap lg:justify-between">
              <div className="w-full px-4 lg:w-1/2 xl:w-6/12">
                <div className="mb-12 max-w-[570px] lg:mb-0">
                  <span className="text-secondary mb-4 block text-base font-semibold">
                    Fale Conosco
                  </span>
                  <h2
                    className="text-dark mb-6 text-[32px] font-bold uppercase sm:text-[40px] lg:text-[36px] xl:text-[40px]"
                  >
                    Solicite orçamentos na Grande Florianopolis
                  </h2>
                  <p className="text-body-color mb-9 text-base leading-relaxed">
                    Solicite de maneira rapida seu orçamento preenchendo os dados ao lado e entraremos em contato, adicione um breve comentario sobre sua necessidade que entramos em contato.
                  </p>
                  <div className="mb-8 flex w-full max-w-[370px]">
                    <div
                      className="bg-secondary text-secondary mr-6 flex h-[60px] w-full max-w-[60px] items-center justify-center overflow-hidden rounded bg-opacity-5 sm:h-[70px] sm:max-w-[70px]"
                    >
                      <svg
                        width="24"
                        height="24"
                    ...
                    <div className="w-full">
                      <h4 className="text-dark mb-1 text-xl font-bold">Onde Estamos</h4>
                  ...
                  <div className="mb-8 flex w-full max-w-[370px]">
                    ...
                    <div className="w-full">
                      <h4 className="text-dark mb-1 text-xl font-bold">Telefone/Celular</h4>
                      <p className="text-body-color text-base">(048)9 9999-9999</p>
                    </div>
                  </div>
                  <div className="mb-8 flex w-full max-w-[370px]">
                    <div
                    ...
                    <div className="w-full">
                      ...
                      <p className="text-body-color text-base">AAAAAAAA@hotmail.com</p>
                    </div>
                  </div>
                </div>
              </div>
                  ...
                  <form>
                    <div className="mb-6">
                      <input
                        ...
                        className="text-body-color border-[f0f0f0] focus:border-secondary w-full rounded border py-3 px-[14px] text-base outline-none focus-visible:shadow-none"
                      />
                    </div>
                    <div className="mb-6">
                      <input
                    ...
                    <div className="mb-6">
                      <textarea
                        rows="6"
                        placeholder="Breve descrição sobre o orçamento:"
                        className="text-body-color border-[f0f0f0] focus:border-secondary w-full resize-none rounded border py-3 px-[14px] text-base outline-none focus-visible:shadow-none"
                      />
                    </div>
                    <div>
                      <button
                        type="submit"
                        className="bg-secondary border-secondary w-full rounded border p-3 text-white transition hover:bg-opacity-90"
                      >
                        Enviar Mensagem
                      </button>
                    </div>
